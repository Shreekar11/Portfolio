...
export const DATA = {
  ...
  At Atlan, he engineers solutions that directly impact **customer experience**. He built a **Microsoft Teams native application** that reduced customer onboarding friction by **90%**, transforming complex multi-step processes into seamless single-click installations. He also led critical infrastructure decisions, **migrating** systems from **DynamoDB** to **PostgreSQL** and **AWS Lambda** to **Kubernetes**, leveraging existing cloud infrastructure to reduce operational overhead while maintaining deployment consistency. \n
  His work spans full-stack development and DevOps, from implementing **Kubernetes deployments** with **Helm charts** to developing **Chrome extensions** with PowerBI integration. He has a proven track record of taking **ownership** of complete modules — including leading **internationalization (i18n)** implementation to expand global accessibility. \n
